...
const bannerData = [
  { info: "left", img: "./banner1.webp", link: '/' },
  { info: "left", img: "./banner2.png", link: '/' },
  { info: "right", img: "./banner3.png", link: '/' },
  { info: "right", img: "./banner4.png", link: '/' },
];
      ...
      >
        {bannerData.map((banner, index) => (
          <SwiperSlide key={index}>
            <BannerBoxV2 info={banner.info} image={banner.img} link={banner.info}/>
          </SwiperSlide>
        ))}
      </Swiper>
