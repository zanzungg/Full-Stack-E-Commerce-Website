...
const AccountSidebar = ({ userInfo, onAvatarChange }) => {
        ...
        <div className='card bg-white shadow-md rounded-md overflow-hidden'>
            <div className='w-full p-5 flex items-center justify-center flex-col'>
                <div className='w-[110px] h-[110px] rounded-full overflow-hidden mb-4 relative group'>
                    <img 
                        src={userInfo?.avatar || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV1Mly7C6D_WWpPXTAO4dF52D9Wd9FKuC9zw&s'}
                        alt="User Avatar"
                ...
                <h3 className='font-bold'>{userInfo?.fullName || 'User Name'}</h3>
                <h6 className='text-[13px] font-medium'>{userInfo?.email || 'user@example.com'}</h6>
            </div>
